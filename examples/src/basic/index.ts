...
import { Bentocord, AnyCommandContext, CommandManager } from '@ayanaware/bentocord';
...
(async () => {
	...
	//	async resolve(ctx: AnyCommandContext, option: AnyValueCommandOption, input) {
	...
	//		]
	//	},
	//	async execute(ctx: AnyCommandContext, options: { count: number }) {
